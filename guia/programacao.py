...
def filter_and_build_epg(urls):
    ...
    for url in urls:
        ...
        special_tvg_ids = {
			'OuterMax.east.us',
			'Showtime Women - Eastern (866).us',
			'Hallmark.Drama.HDTV.(HALDRHD).us',
			'Lifetime Movies (East).us',
			'MGM+ - East (891).us',
			'MGM+ Hits- East (893).us',
			'MGM+ Drive-In (896).us',
			'Crave1 - East HD.ca',
			'Crave2 - East HD.ca',
			'Crave3 - East HD.ca',
			'Crave4 HD.ca',
			'Hallmark Family HD.us',
			'ASPiRE TV HD.us',
			'BET Her (515).us',
			'Me TV.us',
			'VICE.us',
			...
			'ACC Network.us',
			'BET Jams.us',
			'Paramount Network (East).us',
			'AWE TV Network HD.us',
			'VICE.us',
			'ACC.Network.us',
			'UPtv.us',
			'getTV.us',
			...
			'Buzzr.us',
			'Grit.us',
			'WFN-World Fishing Network HD (1679).us',
			'Start TV.us',
			'FanDuel Sports Oklahoma.us',
